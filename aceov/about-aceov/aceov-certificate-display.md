...
{% file src="../../assets/files/Certificate of Registration.pdf" %}
...
{% file src="../../assets/files/Certificate of Good Standing.pdf" %}
...
{% file src="../../assets/files/MSB Registration Certificate.pdf" %}
